...
class BasicAuthFilterTest {
    ...
    private ContainerRequestContext ctxFor(String path, String authHeader) {
    ...
    @Test
    void malformedBase64Returns401() {
    ...
    @Test
    void correctCredentialsSetPrincipalAndDoNotAbort() {
    ...
    @Test
    void passwordWithColonIsAccepted() {
        // Base64("alice:pa:ss") — password itself contains a colon.
    ...
    @Test
    void swaggerPathSkipsAuthCheck() {
    ...
    @Test
    void openapiPathSkipsAuthCheck() {
