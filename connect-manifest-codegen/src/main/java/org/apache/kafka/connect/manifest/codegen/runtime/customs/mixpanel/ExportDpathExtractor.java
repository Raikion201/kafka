...
/**
 * Stub for {@code source-mixpanel/source_mixpanel/components.py ExportDpathExtractor}.
 * Returns empty — full implementation deferred.
 * Registered under {@code source_mixpanel.components.ExportDpathExtractor}.
 */
public final class ExportDpathExtractor implements CustomRecordExtractor {

    public ExportDpathExtractor(Map<String, String> connectorConfig,
