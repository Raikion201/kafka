...
/**
 * Registers all {@code source_jina_ai_reader.components.*} custom component implementations.
 */
public final class JinaAiRegistrar {

    static {
        register();
    }

    private JinaAiRegistrar() {
    }
