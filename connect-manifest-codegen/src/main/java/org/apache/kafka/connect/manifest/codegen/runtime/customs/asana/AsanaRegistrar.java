...
/**
 * Registers all {@code source_asana.components.*} custom component implementations.
 */
public final class AsanaRegistrar {

    static {
        register();
    }

    private AsanaRegistrar() {
    }
