...
/**
 * Stub for {@code source-mixpanel/source_mixpanel/components.py PropertiesTransformation}.
 * Returns the record unchanged — full implementation deferred.
 * Registered under {@code source_mixpanel.components.PropertiesTransformation}.
 */
public final class PropertiesTransformation implements CustomTransformation {

    public PropertiesTransformation(Map<String, String> connectorConfig,
