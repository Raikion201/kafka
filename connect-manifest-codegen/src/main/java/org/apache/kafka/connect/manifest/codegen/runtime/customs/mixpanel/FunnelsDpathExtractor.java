...
/**
 * Stub for {@code source-mixpanel/source_mixpanel/components.py FunnelsDpathExtractor}.
 * Returns empty — full implementation deferred.
 * Registered under {@code source_mixpanel.components.FunnelsDpathExtractor}.
 */
public final class FunnelsDpathExtractor implements CustomRecordExtractor {

    public FunnelsDpathExtractor(Map<String, String> connectorConfig,
