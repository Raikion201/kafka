...
/**
 * Stub for {@code source-mixpanel/source_mixpanel/components.py RevenueDpathExtractor}.
 * Returns empty — full implementation deferred.
 * Registered under {@code source_mixpanel.components.RevenueDpathExtractor}.
 */
public final class RevenueDpathExtractor implements CustomRecordExtractor {

    public RevenueDpathExtractor(Map<String, String> connectorConfig,
