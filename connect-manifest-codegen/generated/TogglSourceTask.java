...
public final class TogglSourceTask extends SourceTask {
  ...
  public void start(Map<String, String> props) {
    ...
    this.cachedCredentials = Base64.getEncoder().encodeToString(
                (config.getApiToken() + ":" + config.getApiPassword()).getBytes(StandardCharsets.UTF_8));
  }

  @Override
  public List<SourceRecord> poll() throws InterruptedException {
    List<SourceRecord> all = new ArrayList<>();
    all.addAll(pollTimeEntries());
    return all;
  }

  private List<SourceRecord> pollTimeEntries() throws InterruptedException {
    final String streamName = "time_entries";
    List<SourceRecord> result = new ArrayList<>();
    StringBuilder urlBuilder = new StringBuilder("https://api.track.toggl.com/api/v9/me/time_entries");
    try {
