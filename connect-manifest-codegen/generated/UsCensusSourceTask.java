...
public final class UsCensusSourceTask extends SourceTask {
  ...
  public List<SourceRecord> poll() throws InterruptedException {
    ...
    all.addAll(pollPopulation());
    return all;
  }

  private List<SourceRecord> pollPopulation() throws InterruptedException {
    final String streamName = "population";
    List<SourceRecord> result = new ArrayList<>();
    StringBuilder urlBuilder = new StringBuilder("https://api.census.gov/data/2020/dec/pl");
    urlBuilder.append("?key=" + config.getApiKey());
    try {
