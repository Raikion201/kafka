...
public final class GoogleCloudStorageJwtSourceTask extends SourceTask {
  private static final ObjectMapper MAPPER = new ObjectMapper();

  private GoogleCloudStorageJwtConnectorConfig config;
  ...
  public void start(Map<String, String> props) {
    this.config = new GoogleCloudStorageJwtConnectorConfig(props);
  ...
  public List<SourceRecord> poll() throws InterruptedException {
    ...
    all.addAll(pollObjects());
    return all;
  }

  private List<SourceRecord> pollObjects() throws InterruptedException {
    final String streamName = "objects";
    List<SourceRecord> result = new ArrayList<>();
    StringBuilder urlBuilder = new StringBuilder("https://storage.googleapis.com/storage/v1" + "/b/" + config.getBucketName() + "/o");
    try {
  ...
  private String buildJwt() {
    try {
      ...
      payloadMap.put("scope", "https://www.googleapis.com/auth/devstorage.read_only");
